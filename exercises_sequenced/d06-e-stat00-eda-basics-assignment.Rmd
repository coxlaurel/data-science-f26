...
**Observations**:
- Ideal cuts are the most common type of cut sitting at over 20,000 versus the 2nd most popular cut which is below 15,000.
...
**Observations**:
- The graph has axes that relate to the hypothesis, however it isn't effective. All the different cuts look almost the same on this graph.
...
**Observations**:
- Ideal cuts are the least pricey because the median line is the lowest of all of them.
...
**Observations**:
- The cut for carat sacrifice seems true because the worst cut has the highest median carat value.
