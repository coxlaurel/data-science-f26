...
df_q3 <- 
  flights %>% 
  filter(
    between(arr_time, sched_arr_time - 10, sched_arr_time + 10)
  )
...
- Was this dataset assembled to study flights *out of* NYC, or *into* NYC? How do you know?
  - It was a dataset to study flight out of NYC because that's the consistent filter across all the data.
