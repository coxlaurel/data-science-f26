...
Active because it engages with what the colleage said.
- Is the bolded response **constructive** or **destructive**? Why?
Constructive because the sentiment is positive.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
It makes me feel heard and like there are now good actionable things to do. 
...
- Is the bolded response **active** or **passive**? Why?
Passive because it doesn't really acknowledge the college's question. 
- Is the bolded response **constructive** or **destructive**? Why?
Destructive because it completely negatively ignores a point the college brought up.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
It makes me feel bad and like my opinion isn't valued.
...
- Is the bolded response **active** or **passive**? Why?
Passive because it isn't related to what the presenter said.
- Is the bolded response **constructive** or **destructive**? Why?
Destructive because it ignores the presenters content.
