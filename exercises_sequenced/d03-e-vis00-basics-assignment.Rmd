...
cut is a rating, color is given a letter rating, clarity is another grouping/rating of sorts.
...
- price generally increases with increasing carats
...
- fair cuts are priced the lowest, and ideal cuts get the highest profit
