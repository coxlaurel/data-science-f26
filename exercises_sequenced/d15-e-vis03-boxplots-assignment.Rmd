...
- Which class tends to be most "middle" for `displ` values?
  - Minivans have the most middle engine displacement
- Which plot is more effective for answering the previous question?
  - The box plot hakes this the clearest because I can see in order from smallest to greatest and locate the middle class.
...
- Make sure to distinguish between the trend in median (bar), quantiles (box edges), and whiskers (vertical lines)
  - Box edges: I notice carats between 3-3.5 have the most variable pricing and carats between 5-5.5 have the most consistent pricing.
  - Bar: Carats between 3-3.5 might be the most cost effective for carat per dollar because it's mean price is less than 2.5-3 carat price.
  - 1-1.5 carat diamonds have the largest spread of prices and 5-5.5 have the least. This supports my observation that 5-5.5 carat diamonds are priced the most consistently.
