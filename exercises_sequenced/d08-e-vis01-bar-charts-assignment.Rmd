...
**Observations**:
- It appears that the bars are side by side instead of stacked.
...
**Observations**:
- SUVs are the most common class of car and 2seater is the least common.
...
**Observations**:
- 4WD is the most common on SUVs
- Pickups are all 4WD
- 2seaters are all RWD
...
v2 broke the bar down into another category which was the wheel drive variable.
...
**Observations**
- Manufacturers have preference to class of car. Jeep, Land Rover, Lincoln, Mercury all only make SUVs.
