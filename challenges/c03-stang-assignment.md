...
- Is there “one true value” for the material properties of Aluminum?
  - There isn’t “one true value” for the material properties of Aluminum
    because `E` and `nu`
- How many aluminum alloys are in this dataset? How do you know?
  - There’s one alloy because in the summary `N.unique` has the values
    of 1.
...
- The 45 degree angle has the largest average nu value and is
  approximate 0.005 larger than the other tested angles.
- The boxes for 0 and 90 degree are very similar is size and sit very
  closely in value together, but the 90 degree box and mean value tread
  just barely lower.
- All boxes lower quantile are larger than the top quantile.
- The graph does reveal a relationship between angle and Poisson’s
  ratio.
...
- Does this graph support or contradict the claim above?
  - The graph doesn’t support the claim “elasticity `E` is an intensive
    material property”. The scatter plots shows tests with similar
    thickness grouped along similar elasticity values. As thickness
    increase so does elasticity.
- Is this evidence *conclusive* one way or another?
  - The evidence isn’t conclusive because if thickness was correlated
    with elasticity, I would expect to see the points with thickness
    0.064 be the second lowest elasticity group. Instead, the
    thicknesses excluding 0.081 are grouped more or less together. One
    reason for this could be that in the experiment, they used 2
    different strain methods where most thicknesses were tested with
    method 1 but the 0.081-in thickness was tested with method 2.
